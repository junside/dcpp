...
function viewBasicInfo(pr_no, artcl_no){ //기본정보 보기
	if(saveMsg('1') == true){
		window.open("pr_view_property_info_main.jsp?pr_no="+pr_no+"&artcl_no="+artcl_no,"property_info","width=100%,height=100%,toolbar=no,location=no,status=no");
		return;
	}
}

function viewNoticeInfo(num){ //공지글 보기
		window.open("ntb_view_content.jsp?num="+num,"notice_info","toolbar=no,location=no,status=no");
		return;				
}
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr> 
          ...
          <td width="691"><object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=5,0,0,0" width="691" height="62">
              <param name=movie value="swf/center_menu.swf">
              <param name=quality value=high>
              <embed src="swf/center_menu.swf" quality=high pluginspage="http://www.macromedia.com/shockwave/download/index.cgi?P1_Prod_Version=ShockwaveFlash" type="application/x-shockwave-flash" width="691" height="62">
              </embed> 
            </object></td>
        </tr>
      </table>
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td width="79%"><object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=5,0,0,0" width="909" height="341">
              <param name=movie value="swf/center_text.swf">
              <param name=quality value=high>
              <embed src="swf/center_text.swf" quality=high pluginspage="http://www.macromedia.com/shockwave/download/index.cgi?P1_Prod_Version=ShockwaveFlash" type="application/x-shockwave-flash" width="909" height="341">
              </embed> 
            </object></td>
        </tr>
      </table>
		   ...
		   <tr> 
			...
			<td valign = "top">
				<table class="tab11">
				   ...
				   <tr>
					<td>                      	                       
						<font color="#FF3300">플라즈마물성데이터센터</font>에 오신것을 환영합니다. 플라즈마물성데이터센터는 물리 화학분야 참조표준 개발을 위하여 지식경제부에서 지정한 국내 유일의 데이터 센터입니다.
					</td>
				   </tr>
				   <tr>
					<td>                      	                       
						<a href="c_intro.jsp"><img src="images/img_cont/more.gif" width="36" height="14" border="0"></a>
					</td>
				   </tr>			   
				</table>
			</td>
...
<map name="Map">
  <area shape="rect" coords="21,4,161,58" href="index.jsp">
</map>
<map name="Map2">
  <area shape="rect" coords="276,32,327,50" href="#">
</map>
<map name="Map3"> 
  <area shape="rect" coords="259,30,310,49" href="pr_search.jsp">
</map>
<map name="Map4">
