...
<title>Text View of Plasma Properties</title>
</head>
<body>
...
<p class="level2">Plasma Properties TEXT View</p>
<span class="help">Total Count : <%=check.length%></span><br>
<%
...
<col width="250">
<tr>
    <th class="thr">Properties Number : </th>
  ...
  <tr>
	...
	<tr>
   	<th class="thrt" rowspan="<%=v_dt_count+1%>">Numeric Data : </th>
    <th class="thc">
    X
    </th>
    <th class="thc">
