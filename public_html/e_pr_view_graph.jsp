...
<title>Graph Viewer for Plasma Properties</title>
</head>
<body>
...
function viewDataInfo(pr_no){ //수치정보 보기
	...
	window.open("e_pr_view_graph_data.jsp?pr_no="+pr_no,"property_info","width=700,height=650,toolbar=no,location=no,status=no");
	return;
}
...
<p class="level2">Graph and Data for Plasma Properties</p>
<table class="tab2">
<col width="110">
<col width="540">
  <tr>
  ...
  <tr>
  	<th class="thc">Expression</th>
    <td class="tdl">
		<%=expression%></td>
  </tr>
  <tr>
	<th class="thc">Numeric Data</th>   
  	<td class="tdl"> 
  	  <a href="javascript:viewDataInfo('<%=pr_no%>')" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('viewImage','','images/img_cont/eng/view_s_upper.gif',1)"><img src="images/img_cont/eng/view_s_normal.gif" name="viewImage" width="60" height="20" border="0" id="viewImage" /></a>  	</td>
  <tr>
...
<div class="bbtn_c">
<a href="javascript:exitInfo()" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('confirmImage','','images/img_cont/eng/confirm_upper.gif',1)"><img src="images/img_cont/eng/confirm_normal.gif" name="confirmImage" width="80" height="24" border="0" id="confirmImage" /></a>
</div>
</div>
</form>
