...
<%
	...
	returnValue = inputControl.insert_HP_Article(request);
	if(returnValue!=false){
		returnMsg = "Content insert is success!";
		option = 1;
	}else{
		returnMsg = "Content insert is fail!";
		option = 0;
	}
%>
