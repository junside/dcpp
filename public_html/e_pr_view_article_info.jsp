...
*/
	...
	String j_code = art_Info.getPL_RACI_CODE_EXP_ENG();
...
<title>Reference Data Viewer for Plasma Properties</title>
</head>
<body>
...
<p class="level2">Reference Data for Plasma Properties</p>
<table class="tab2">
	<col width="20%">
	<col width="80%">
	<tr>
		<th class="thla">Reference Type</th>
		<td class="tdl"><%=j_code%></td>
	</tr>
	<tr>
		<th class="thla">Title</th>		
		<td class="tdl"><%=a_title%></td>
	</tr>
	<tr>
		<th class="thla">Author</th>
		<td class="tdl"><%=a_auth_e%></td>
	</tr>
	<tr>
		<th class="thla">Journal Name</th>
	...
	<tr>
		<th class="thla">Volume</th>
		<td class="tdl"><%=j_vol%></td>
	</tr>
	<tr>
		<th class="thla">Number</th>
		<td class="tdl"><%=j_num%></td>
	</tr>
	<tr>
		<th class="thla">start page</th>
		<td class="tdl"><%=a_stp%></td>
	</tr>
	<tr>
		<th class="thla">end page</th>
		<td class="tdl"><%=a_edp%></td>
	</tr>
	<tr>
		<th class="thla">published year</th>
		<td class="tdl"><%=j_year%></td>
	</tr>
</table>
<div class="bbtn_c">
<a href="javascript:confirmInfo()" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image1','','images/img_cont/eng/confirm_upper.gif',1)"><img src="images/img_cont/eng/confirm_normal.gif" name="Image1" width="80" height="24" border="0" id="Image1" /></a>
</div>
</div>
</form>
