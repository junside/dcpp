...
function selectPartID(part_id){
	if(part_id == 'part_1_sym'){
		...
		var mp = "part_1_mp";//mp
		window.open("pr_select_part2_info.jsp?id="+id+"&sym="+sym+"&mp="+mp,"select_Part","width=700,height=500,resizable=yes,scrollbars=yes");
	}else{
		var form2 = document.form1;	
		var id = "part_2_id";//id
		var sym = "part_2_sym";//sym	
		var mp = form2.part_1_mp.value;//mp
		window.open("pr_select_part2_info.jsp?id="+id+"&sym="+sym+"&mp="+mp,"select_Part","width=700,height=500,resizable=yes,scrollbars=yes");
	}
...
<col width="200">
  ...
  <th class="thc"><font color = red>표적입자</font></th>
  	<td class="tdl">
  		...
  		<input type="hidden" name="part_1_mp" value=""/>
  ...
  <th class="thc">입사입자</th>
  	<td class="tdl">
		<input type="text" name="part_2_sym" value="" onfocus="addExpression('part_2_sym')" size="15" maxlength="200">
  		...
  		<input type="hidden" name="part_2_mp" value=""/>
