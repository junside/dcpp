...
<%
	...
	*/
	...
	String pr_no = "B201225982";//request.getParameter("pr_no");
...
function viewArticleInfo(artcl_no){ //참고문헌 보기
	if(saveMsg('1') == true){
		window.open("pr_view_article_info_main.jsp?artcl_no="+artcl_no,"article_info","width=100%,height=100%,toolbar=no,location=no, scrollbar=auto");
		return;
	}
}
