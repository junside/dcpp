...
<p class="level2">플라즈마 물성입자 표현식 입력</p>
<span class="help">적절한 유형을 선택하신후 Tag의 사이 값들을 변경하여 입력하세요.</span><br>
<table class="tab1">
	<col width="25%">
	<col width="25%">
	<col width="25%">
	<col width="25%">
	<tr height="40">
		<th class="thc">선택유형</th>		
		<td class="tdl"><a href="javascript:sup()">A<sup>b</sup>&nbsp;유형</a></td>
		<td class="tdl"><a href="javascript:sub()">A<sub>b</sub>&nbsp;유형</a></td>
		<td class="tdl"><a href="javascript:sigma()">&sigma;&nbsp;(sigma)</a></td>
	</tr>
	<tr height="40">
		<th class="thc">입자</th>
		<td class="tdl" colspan="3">
			<input type='text' name='part' size='50' maxlength="500" onkeyup="addExpression()" value=''>
			<a href="javascript:clear()">지우기</a>
		</td>
	</tr>	
	<tr height="40">
		<th class="thc">입자 표현</th>
  		<td class="tdl" id="expression" colspan="3"></td>  
	</tr>
</table>
<div class="bbtn_c">
	<a href="javascript:insert()" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('insert','','images/img_cont/insert_upper.gif',1)"><img src="images/img_cont/insert_normal.gif" name="insert" width="80" height="24" border="0" id="insert" /></a>
</div>
</div>
</form>
