...
<form method="post" name="writeform" action="qab_writeForm_check.jsp" onsubmit="return writeSave()">
...
<table class="tab2">
	...
	<tr>	
		<td class="tdc" colspan="2">
		  ...
		  <input type="button" value="go to list" OnClick="window.location='qab_list.jsp'">
		</td>
	</tr>
<tr>      
</table>    
