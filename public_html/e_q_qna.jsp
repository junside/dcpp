      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td width="239" align="left" valign="top">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td><img src="images/left_cont/eng/q_q&a_left_01.gif" width="239" height="55"></td>
              </tr>
              <tr>
                <td><img src="images/left_cont/eng/q_q&a_left_02.gif" width="239" height="349"></td>
              </tr>
            </table>
          </td>
          <td width="686" align="left" valign="top">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr> 
                <td width="3%">&nbsp;</td>
                <td width="97%">
                	<iframe src="qab_list.jsp" name="question" width="100%"marginwidth="0"  height="500" marginheight="0" frameborder="0"></iframe>
                </td>
              </tr>
              <tr> 
                <td colspan="2">&nbsp;</td>
