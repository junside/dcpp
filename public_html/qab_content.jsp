...
<col width="200">
  ...
  <tr height="30">  
  	<td class="tdc" colspan="4">
    	<a href="qab_updateForm.jsp?num=<%=num%>">Modify</a>
    	<a href="qab_deleteForm.jsp?num=<%=num%>">Delete</a>
    	<a href="qab_writeForm.jsp?num=<%=num%>&ref=<%=ref%>&re_step=<%=re_step%>&re_level=<%=re_level%>">Reply</a>
    	<a href="qab_list.jsp">List</a>
   	</td>    
  </tr>
</table>    
</form>      
