...
<div>  
    <div class='tabs-area'>  
        ...
        <li><a id='tab2' title="Photon Impact" href="javascript:tabs('2');">Photon Impact (<%=PI_COUNT %> 건)</a></li>  
        <li><a id='tab3' title="Heavy particle Impact" href="javascript:tabs('3');">Heavy particle Impact (<%=HI_COUNT %> 건)</a></li>  
        </ul>  
    </div>  
