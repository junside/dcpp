...
<%
	...
	int num = Integer.parseInt(request.getParameter("num"));
  	...
  	Board_Info article = board_process.select_HP_Article_Content(num);
...
<col width="200">
  ...
  <tr height="30">  
  	<td class="tdc" colspan="4">
    	<a href="hpb_updateForm.jsp?num=<%=num%>">Modify</a>
    	<a href="hpb_deleteForm.jsp?num=<%=num%>">Delete</a>
    	<a href="hpb_writeForm.jsp?num=<%=num%>&ref=<%=ref%>&re_step=<%=re_step%>&re_level=<%=re_level%>">Reply</a>
    	<a href="hpb_list.jsp">List</a>
   	</td>    
  </tr>
</table>    
</form>      
