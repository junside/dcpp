...
<form method="post" name="writeform" action="hpb_writeForm_check.jsp" onsubmit="return writeSave()">
...
<table class="tab2">
	...
	<tr>	
		<td class="tdc" colspan="2">
		  ...
		  <input type="button" value="go to list" OnClick="window.location='hpb_list.jsp'">
		</td>
	</tr>
<tr>      
</table>    
