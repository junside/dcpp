...
<form method="post" name="writeform" action="ntb_updateForm_check.jsp" onsubmit="return writeSave()">
...
<col width="80%">
  ...
  <tr>  
     ...
     <input type="button" value="go to list" onclick="document.location.href='ntb_list.jsp'">
   	</td>    
  </tr>
</table>    
</form>      
